...
from elderly_recsys_tools import *
...
#%% load data from excel tables - data se bo še spreminjal in nalgal v excel tabele (garintologi bojo za to poskrbel)
...
#sprehod čez dictionarije in datafrejme da zložimo te sezname 
single_act_lst = []
...
#%%
####################################################################################
#verzija6 pomen da use ostaja isto sam več kontekstov dodajamo
...
# te funjcije so v toolsih, da se boljš računajo tile scori
# df - dataframe in dc - dictionary
# te funkcije to sparsajo in uredijo
...
#%% Data matrix
# ta je matrika ki uporabi use funkcije in je skupna za use konteskte 
# upošteva use score in statistiko in kompatibilnost
# to kompat. matriko dela doktorska študentka ročno in je še nimamo, se bo še naknadno 
# vključlo v kodo
# D_lst -> redka matrika, seznam user id, score itd. 
